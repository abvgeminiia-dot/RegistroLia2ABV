    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (validIdRecords.length !== validatorIds.length) {
                const foundValidIds = new Set(validIdRecords.map(rec => rec.get('IDValidadorTardeFecha1')));
        ...
        <div className="container">
            <div className="form-wrapper">
                <div className="header-card">
                    ...
                    <h2>3 de noviembre de 2025 - 8:00 a.m. a 12:00 p.m. y 4 de noviembre de 2025 1:30 p.m. a 5:00 p.m. TURNO:TARDE</h2>
                </div>
