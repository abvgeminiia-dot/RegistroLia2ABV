...
const FormABV6 = () => {
    ...
    const formatIdentifier = (value) => {
        ...
        // J/G (RIF) se limitan a 9 dígitos numéricos. Cédulas (V/E/P) a 10 dígitos.
        ...
        // El límite total de la cadena es 11 para J/G (L-DDDDDDDDD) y 12 para Cédulas.
        ...
        <div className="container">
            <div className="form-wrapper">
                <div className="header-card">
                    ...
                    <h2>4 de noviembre de 2025 - 8:00 a.m. a 12:00 p.m. y 6 de noviembre de 2025 8:00 a.m. a 12:00 p.m. TURNO:MAÑANA</h2>
                </div>
